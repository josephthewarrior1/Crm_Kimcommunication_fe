...
export const EditCompanyModal: React.FC<EditCompanyModalProps> = ({
  ...
  useEffect(() => {
    if (company) {
      ...
      setSelectedGroupId(company.group?.id ? company.group.id.toString() : '');
      setGroupSearchQuery('');
      setAddress(company.address || '');
      setOfficePhone(company.officePhone || '');
      setWebsite(company.website || '');
      setIndustry(company.industry || '');
      setCompanySizeRevenue(company.companySizeRevenue || '');
      setCompanySizeEmployee(company.companySizeEmployee || '');
      setCompanyHardware(company.companyHardware || '');
