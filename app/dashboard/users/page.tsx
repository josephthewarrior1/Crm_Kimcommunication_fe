...
import { Users, Loader2, Trash2, Shield, UserPlus, AlertCircle, RefreshCw, X, User, Mail, Lock, ShieldCheck } from 'lucide-react';
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full px-3 py-2 bg-slate-50 border border-slate-200 focus:border-blue-500 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none transition-all text-xs"
                    required
                  />
                </div>
                <div>
