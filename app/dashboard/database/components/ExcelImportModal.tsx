          ...
          <div className="ms-modal-form">
            <div className="ms-modal-header">
              ...
              <p className="ms-modal-description">
                ...
                Data kontak dan perusahaan tempat bekerja mengikuti Excel. Kolom kosong dan email lama tetap dipertahankan. Office Phone cabang diperbarui mengikuti Excel jika diisi. Data master perusahaan yang sudah terisi tidak ditimpa.
            ...
            {/* Search & Filter Bar */}
            <div className="flex flex-col xl:flex-row gap-2 items-stretch xl:items-center justify-between shrink-0">
              {/* Filter Tabs */}
            ...
            <div className="flex flex-col">
              ...
              <div className="overflow-x-auto border border-slate-200 rounded-md bg-white" role="region" aria-label="Rincian preview Excel" tabIndex={0}>
                {filteredRows.length === 0 ? (
                  ...
                  <table className="w-full table-fixed text-left border-collapse text-sm block xl:table">
                    ...
                    <tbody className="divide-y divide-slate-200 text-slate-700 block xl:table-row-group">
                      {filteredRows.map((r) => {
                        const isProblem = r.isIssue;
                        return (
                          <tr 
                            key={r.rowNum} 
                            className={`transition-colors block xl:table-row [&>td]:block xl:[&>td]:table-cell [&>td]:align-top [&>td]:break-words ${
                              r.status === 'INCOMPLETE'
                          ...
                          >
                            ...
                            <td className={`py-4 px-4 text-base leading-6 ${
                              ...
                              <span className="xl:hidden block font-semibold mb-2">{isProblem ? 'Perlu diperbaiki' : 'Keterangan'}</span>
